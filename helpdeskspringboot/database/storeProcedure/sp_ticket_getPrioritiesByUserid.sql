...
DROP PROCEDURE IF EXISTS sp_ticket_getPrioritiesByUserid;
...
-- customer: call sp_ticket_getPrioritiesByUserid(1)
-- supporter: call sp_ticket_getPrioritiesByUserid(2)
-- admin: call sp_ticket_getPrioritiesByUserid(3)

CREATE PROCEDURE sp_ticket_getPrioritiesByUserid(in_userid int)
BEGIN
...
if userRole = "ROLE_CUSTOMER" then
	...
	from(
		select 	distinct a.priorityid as priorityid
		from ticket a
